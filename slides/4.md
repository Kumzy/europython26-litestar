...
<li v-click="1">Auth, DB sessions, pagination, DTOs…</li>
<li v-click="2" class="muted">Each dependency is defined individually</li>
<li v-click="3" class="muted">Still fine at 5 endpoints</li>
</ul>
